...
/-!
# Anderson Localization Threshold from J-Cost (Plan v7 sixty-first pass)

## Status: STRUCTURAL THEOREM (0 sorry, 0 axiom).

Disorder-driven metal-insulator transition at J-cost = J(φ) on the conductance ratio.
...
namespace AndersonLocalizationFromJCost
...
noncomputable def cert : AndersonLocCert where
...
end AndersonLocalizationFromJCost
end CondensedMatter
